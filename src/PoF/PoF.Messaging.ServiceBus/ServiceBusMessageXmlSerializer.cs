...
{
    internal class ServiceBusMessageXmlSerializer
    {
        private ServiceBusMessageXmlSerializer()
        {

        }

        public static ServiceBusMessageXmlSerializer Instance { get; } = new ServiceBusMessageXmlSerializer();
